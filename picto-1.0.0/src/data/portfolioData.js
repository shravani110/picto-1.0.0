export const profile = {
  ...
  about: [
    "I enjoy turning ideas into clean, engaging interfaces that feel natural for users. My work blends creativity, mobile-first thinking, and a practical engineering mindset.",
  ...
  linkedIn: "https://www.linkedin.com/in/shravani-dasari11",
  github: "https://github.com/shravani110",
};
...
export const processSteps = [
  {
    ...
    title: "Discover",
    description:
      "I start by understanding the user, the problem, and the core goal before planning screens or flows.",
    svgPath:
  ...
  },
  {
    ...
    title: "Design",
    description:
      "I shape layouts, user flows, and interfaces that feel clean, useful, and easy to navigate.",
    svgPath:
  ...
  },
  {
    ...
    title: "Develop",
    description:
      "I turn designs into responsive apps using modern tools like React, React Native, Firebase, and front-end frameworks.",
    svgPath:
  ...
  },
  {
    ...
    title: "Deliver",
    description:
      "I finish by refining details, checking responsiveness, and making sure the final product is practical and polished.",
    svgPath:
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "A minimalist AI app transforming conversational text into organized schedules, featuring automated reminders and calendars.",
    detailedDescription: "The Intelligent Task Manager is an AI-powered productivity application that revolutionizes task management by converting natural language input into organized, actionable tasks with automatic scheduling and intelligent reminders. The app uses advanced natural language processing to understand user intent and automatically extract due dates, priorities, and categories from conversational text.\n\nCore Implementation Details:\n• NLP Engine: Integrated advanced natural language processing to parse conversational text and extract entities like dates, times, and task categories.\n• AI Task Parsing: Implemented machine learning models to automatically suggest task priorities based on content analysis and user patterns.\n• Calendar Integration: Connected with native device calendars (iOS Calendar, Google Calendar, Outlook) for seamless synchronization.\n• Smart Reminders: Built intelligent reminder system that learns user preferences and sends notifications at optimal times based on behavior.\n• Minimalist UI: Designed clean, distraction-free interface following modern design principles with emphasis on usability.\n• Recurring Tasks: Implemented sophisticated recurrence patterns for daily, weekly, monthly, and custom recurring tasks.\n• Priority Management: Created intelligent prioritization algorithm that adjusts task importance based on deadlines and dependencies.\n• Cross-platform Sync: Built robust synchronization system ensuring tasks remain consistent across all user devices.",
    link: "mailto:shravanidasari110@gmail.com?subject=Intelligent%20Task%20Manager",
    figmaLink: null,
  },
  {
    id: 4,
...
export const skills = [
  ...
  },
  {
    ...
    description:
      "Proficient in C, Python and Certified Python Essentials (Cisco).",
  },
  {
    id: 3,
...
export const achievements = [
  ...
  },
  {
    ...
    date: "SKILLS",
    comments: "Chart",
    title: "UI/UX Design (Figma), Mobile Dev (React Native, Android SDK), Python, C, HTML, React, Backend & Cloud (Firebase, MySQL), Git, VS Code.",
    link: profile.linkedIn,
  },
];
...
export const education = [
  {
    ...
    description:
      "Sree Chaitanya Institute of Technological Sciences, 2022-2026, 76.8%.",
  },
  {
    id: 2,
    title: "Intermediate - MPC",
    description: "Alphores Junior College, 2020-2022, 95.1%.",
  },
  {
    id: 3,
    title: "SSC",
    description: "Bhagavathi High School, 2019-2020, 100%.",
  },
];
...
export const testimonials = [
  {
    message:
      "My work focuses on combining clean front-end design with practical mobile functionality.",
    quote:
      "I enjoy building interfaces that feel simple, responsive, and useful for real users.",
    name: "Shravani Dasari",
    designation: "Android and Mobile Developer",
  },
  {
    message:
      "I am continuously learning through projects, hackathons, certifications, and hands-on experimentation.",
    quote:
      "Every project is a chance to strengthen my design thinking, coding workflow, and product mindset.",
    name: "Shravani Dasari",
    designation: "Senior Undergraduate",
  },
  {
    message:
      "I want the products I build to feel thoughtful, accessible, and visually engaging from the first interaction.",
    quote:
      "My goal is to create digital experiences that balance usability, aesthetics, and strong technical execution.",
    name: "Shravani Dasari",
    designation: "Frontend and Mobile Enthusiast",
  },
];
